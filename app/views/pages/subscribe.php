<?php require APPROOT . '/views/inc/header.php'; ?>
    <div class="row">
    	<div class="col-12 col-lg-9 mx-auto">
	      <h4 class="text-primary m-0">Your seven days free trial has expired.</h4>
	      	...
	      	<div class="col-md-6">
	      		<div class="card rounded-4 shadow-lg border-0 mb-5">
	      			<div class="card-body">
	      				...
	      				<h2 class="fs-1 fw-bold mt-4 mb-5">&#8358;1,000</h2>
	      				...
	      				<div class="d-grid">
	      					<a href="https://paylink.alero.africa/v1/pl/946a9a4a-07a4-4b4b-8b6e-f96b52b72a4b" class="btn btn-dark rounded-4 mt-5 mb-4">
	      						Subscribe
	      					</a>
	      				</div>
	      			</div>
	      	...
	      	<div class="col-md-6">
	      		<div class="card rounded-4 text-bg-dark shadow-lg border-0 mb-5">
	      			<div class="card-body">
	      				...
	      				<h2 class="fs-1 fw-bold mt-4 mb-5">&#8358;10,000</h2>
	      				<ul class="list-group list-group-flush fs-5 mb-5">
	      					...
	      					<li class="list-group-item text-bg-dark">
	      						<i class="fa fa-percent"></i>17 Off &nbsp;<s class="text-danger">-&#8358;2000</s>
	      					</li>
	      				</ul>
	      				<div class="d-grid">
	      					<a href="https://paylink.alero.africa/v1/pl/946a9a4a-07a4-4b4b-8b6e-f96b52b72a4b" class="btn btn-light rounded-4 mb-4">
	      						Subscribe
	      					</a>
	      				</div>
	      			</div>
