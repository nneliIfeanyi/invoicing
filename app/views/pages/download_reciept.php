...
<table cellpadding="7" style="text-align:left;" >
	<tr  style="font-weight:bold;font-size:16;" bgcolor="#000" color="white">
		<th width="470">Service Description</th>
    <th width="188">Price</th>
	</tr>';
  while ($result = mysqli_fetch_array($query)) {
    $dsc = $result['dsc'];
    $rate = $result['rate'];
  ...
  //$pdf->Ln(2);
  $html2 = '
<table cellpadding="3" color="#0a5d0b">
	<tr  style="font-weight:bold;font-size:11;">
		<th width="470"  style="text-align:right;">Total:</th>
    <th width="188">N' . put_coma($total) . '</th>
	</tr>';
  if (!empty($paid)) {
    $html2 .= '
	<tr  style="font-weight:bold;font-size:11;">
		<td style="text-align:right;">Paid:</td>
    <td>N' . put_coma($paid) . '</td>
	</tr>';
    if ($total >= $paid) {
      $html2 .= '
	<tr  style="font-weight:bold;font-size:11;">
		<td  style="text-align:right;">Balance:</td>
    <td>N' . put_coma($total - $paid) . '</td>
	</tr>';
    } else {
      $html2 .= '
	<tr  style="font-weight:bold;font-size:11;">
		<td style="text-align:right;">Balance:</td>
    <td color="red">' . $total - $paid . '</td>
	</tr>';
    }
  } else // Paid is empty
  ...
  <tr  style="font-weight:bold;font-size:11;">
		<td style="text-align:right;">Balance:</td>
    <td color="red">N' . put_coma($total) . '</td>
	</tr>
  </table>';
  }
...
$pdf->cell(86, 0, '_______________________________________________________________________________________________________', 0, '', '', '');
