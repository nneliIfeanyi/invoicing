               ...
               <h3 class="py-3">Today's Sales 
                ...
                <div class="row">
                 ...
                 <div class="col-md-6">
                     <div class="card">
                          ...
                          <div class="p-2">
                             <input class="form-control" placeholder="Search for goods or date" oninput="w3.filterHTML('#id01', '.item', this.value)">
                          </div>
                      </div>
                  </div>
                  <?php endif;?>
                ...
                <div class="table-responsive table-responsive-data2">
                    <table class="table table-data2" id="id01">
                        ...
                        <tbody>
                          <?php $count =1; foreach($data['today_sales'] as $sales):?>
               ...
               <h3 class="py-3">From
                ...
                <div class="table-responsive table-responsive-data2">
                    <table class="table table-data2" id="id01">
                        ...
                        <tbody>
                          <?php $count =1; foreach($data['week_sales'] as $sales):?>
                            <tr class="tr-shadow item">
                                <!-- <td><?= $count;?></td> -->
                                <td><?= $sales->qty;?></td>
                                <td>
               ...
               <h3 class="py-3">Yesterday's Sales 
                ...
                <div class="table-responsive table-responsive-data2">
                    <table class="table table-data2" id="id01">
                        ...
                        <tbody>
                          <?php $count =1; foreach($data['yesterday_sales'] as $sales):?>
                            <tr class="tr-shadow item">
                                <!-- <td><?= $count;?></td> -->
                                <td><?= $sales->qty;?></td>
                                <td>
