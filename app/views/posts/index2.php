...
<section class="statistic">
    <div class="section__content section__content--p30">
        ...
        <div class="row mt-3"> 
           ...
           <?php elseif(!empty($customer_info->initial_doc) AND $customer_info->edited == 'false'):?>
           <!-- File has been downloaded but not edited -->
                <div class="col-6"> 
                 <button id="share" class="btn btn-sm btn-outline-dark">
...
<script>
    ...
    const path = "../output/invoice79855.pdf";
