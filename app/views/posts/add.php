            ...
            <tbody>
              <?php for ($i=1; $i < 7; $i++) { 
                ...
                <tr>
                  ...
                  <td>
                    <input type="number" name="rate[]" min="0" data-parsley-pattern="^[0-9.]+$" data-parsley-trigger="keyup" class="form-input" value="" style="width: 20vw;">
                  </td>
                </tr>
                <?php
              }?>
