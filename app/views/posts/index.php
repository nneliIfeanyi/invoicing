        ...
        <div class="container-fluid">
          ...
          <?php if(!empty($data['transactions'])):?>
            <div class="row form-group">
                <div class="col-md-12">
                    <label for="textarea-input" class=" form-control-label">Filter Transactions</label>
                </div>
                <div class="col-md-12">
                    <input class="form-control" placeholder="Search customer name" oninput="w3.filterHTML('#id01', '.item', this.value)"> 
                </div>
            </div>
            <div id="id01">
            ...
            ?>
            <div class="card card-body mb-3 item">
