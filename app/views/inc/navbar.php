...
<nav class="navbar navbar-expand-lg p-0 navbar-dark bg-dark mb-3 sticky-top border-bottom border-primary">
  <div class="container">
    <a class="navbar-brand" href="<?= URLROOT;?>/pages">Invoice<span class="text-primary">Online</span></a>
